...
export const AI_TOOLS: Tool[] = [
    { name: "Feature.fm", description: "Professionelle Smartlinks und Pre-Saves.", price: "ab ca. 19 $/Monat", category: ToolCategory.Distribution },
    { name: "Linkfire", description: "Alternative für professionelle Smartlinks.", price: "ab ca. 26,99 $/Monat", category: ToolCategory.Distribution },
    { name: "Odesli (Songlink)", description: "Kostenlose Smartlink-Alternative.", price: "Kostenlos", category: ToolCategory.Distribution },
    { name: "Songstats", description: "Echtzeit-Benachrichtigungen über Playlist-Platzierungen.", price: "ab ca. 12,99 $/Monat", category: ToolCategory.Distribution },
    { name: "Rotor Videos", description: "Musik-Visualizer und Lyric-Videos.", price: "Pläne ab ca. 20-49 $/Monat", category: ToolCategory.Visuals },
    { name: "Specterr", description: "Alternative für Musik-Visualizer.", price: "Pläne ab ca. 20-49 $/Monat", category: ToolCategory.Visuals },
    { name: "Kaiber AI", description: "KI-generierte Loops im düsteren 'Dark/Car/Anime'-Stil.", price: "Pläne ab ca. 5-29 $/Monat", category: ToolCategory.Visuals },
    { name: "Headliner", description: "Audiogramme, Lyric Videos, Kurzclips.", price: "Free + Pro ab 7,99 $/Monat", category: ToolCategory.Visuals },
    { name: "Kapwing AI", description: "Schnelle Erstellung und Untertitelung von 9:16-Videos.", price: "Pro ab ca. 16-24 $/Monat", category: ToolCategory.Shortform },
    { name: "VEED", description: "Alternative für Videoerstellung und Untertitelung.", price: "Kostenlose & bezahlte Pläne", category: ToolCategory.Shortform },
    { name: "Flick", description: "KI-gestützte Captions und Hashtag-Strategien.", price: "ab ca. £11–24/Monat", category: ToolCategory.Planning },
    { name: "FeedHive", description: "Ideenfindung und Content-Planung.", price: "ab ca. 19 €/Monat", category: ToolCategory.Planning },
    { name: "Copy.ai", description: "KI-generierte Captions und Social Media Posts.", price: "Free + Pro 36 $/Monat", category: ToolCategory.Planning },
    { name: "Buffer", description: "Automatisierung des Postings.", price: "Kostenloser Plan & ab ca. 6 $/Channel/Monat", category: ToolCategory.Posting },
    { name: "Later", description: "Alternative für Posting-Automatisierung.", price: "ab ca. 33 $/Monat", category: ToolCategory.Posting },
    { name: "Chartmetric", description: "Phonk-Wellen und Playlists frühzeitig erkennen.", price: "ab ca. 60 $/Monat", category: ToolCategory.Analysis },
    { name: "Exolyt", description: "Aufstrebende TikTok-Sounds erkennen.", price: "Unbekannt", category: ToolCategory.Analysis },
    { name: "Soundcharts", description: "Echtzeit-Radio/Playlist/Chartdaten für Trend-Radar.", price: "Custom", category: ToolCategory.Analysis },
    { name: "Identifyy (HAAWK)", description: "Monetarisiert UGC auf YouTube und Facebook.", price: "Kostenlos (Umsatzbeteiligung)", category: ToolCategory.Monetization },
    { name: "SubmitHub", description: "Direktes Playlist-Pitching.", price: "Pay-per-Submit", category: ToolCategory.Monetization },
    { name: "Groover", description: "Alternative für Playlist-Pitching.", price: "Pay-per-Submit", category: ToolCategory.Monetization },
